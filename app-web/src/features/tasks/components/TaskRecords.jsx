...
import { formatRelativeTimeCompact } from '../../../shared/lib/time-format.js';
...
export function TaskRecordCard({ quest, now }) {
  ...
  const ago = formatRelativeTimeCompact(quest.createdAt, now);
  const completedAgo = quest.completedAt ? formatRelativeTimeCompact(quest.completedAt, now) : null;
