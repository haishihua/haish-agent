...
for (const runtimeHydrated of [true, false]) {
  test(`rapid mode switches reuse current summaries with runtimeHydrated=${runtimeHydrated}`, async () => {
    const task = (taskId) => ({ taskId, updatedAt: 1, runtimeHydrated });
    let workspaceState = {
